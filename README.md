...
Skips golden banana collection dance cutscenes. That's it!

Built using [theballaam96's RecompModSetup](https://github.com/theballaam96/RecompModSetup).

## Installation

1. Download the latest `gb_dance_skips.nrm` from Releases.
...
The produced mod file is named `gb_dance_skips.nrm`.
